...
**Purpose:** Your personal knowledge library. Well-formed, structured insights organized hierarchically by topic, ready for reference and application.

## What Goes Here

- Core concepts and frameworks
- Structured knowledge about topics
- Integrated ideas from multiple sources
- Actionable principles and practices
- Evergreen knowledge (doesn't become outdated)

## How It Works

1. **Develop** - From [Fleeting Notes](../01-fleeting-notes/README.md) and [Literature Notes](../02-literature-notes/README.md)
2. **Structure** - Using the [note template](../.templates/note.md)
3. **Connect** - Link to related concepts and ideas
4. **Maintain** - Update with new insights over time
...
**Includes:**
- [Social & Interpersonal Skills](./personal-development/social-interpersonal-skills/README.md) - Communication and relationships

### 🏥 [Wellbeing](./wellbeing/README.md)
Mental and physical health, fitness, sleep, mindfulness, and mental health.

**Includes:**
- [Sleep](./wellbeing/sleep/README.md) - Sleep optimization and circadian rhythms
- [Fitness](./wellbeing/fitness/README.md) - Exercise and physical health
- [Mindfulness](./wellbeing/mindfulness/README.md) - Meditation and nervous system regulation
- [Mental Health](./wellbeing/mental-health/README.md) - Psychological well-being

### 📚 [Productivity](./productivity/README.md)
Time management, goal setting, deep work, and systems for effectiveness.

**Includes:**
- [Time Management](./productivity/time-management/README.md) - Slow productivity and deep life frameworks
- [Goal Setting](./productivity/goal-setting/README.md) - Systems and dream management
- [Focus & Deep Work](./productivity/focus-deep-work/README.md) - Concentration and meaningful work
...
**Includes:**
- [Hobbies & Interests](./leisure/hobbies-interests/README.md) - Personal projects and skills
...
**Health & Wellbeing:**
- [Sleep Optimization](./wellbeing/sleep/README.md)
- [Fitness](./wellbeing/fitness/README.md)
...
- [Entertainment & Media](./leisure/entertainment-media/README.md)

## Note Quality Standards

Every permanent note should have:
- ✅ Clear, specific title
- ✅ 1-2 paragraph summary
- ✅ 3-5 key ideas with details
- ✅ Practical "How I Use This" section
- ✅ Related notes (2+ links)
- ✅ Current metadata (created, updated dates)

## How This Fits In

**Receives knowledge from:**
- [Fleeting Notes](../01-fleeting-notes/README.md) - Raw ideas
- [Literature Notes](../02-literature-notes/README.md) - Curated sources

**Supports:**
- [Projects](../04-projects/README.md) - Applied knowledge
- [Tracking](../05-tracking/README.md) - Progress and goals
