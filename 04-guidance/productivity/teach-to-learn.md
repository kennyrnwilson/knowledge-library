...
- Revisit your gaps in the original materials
...
```
Learn → Feynman Explain → Identify Gaps → Revisit Source → Teach Others → Review
```
...
3. **No Spaced Review** - Learning once and forgetting
...
3. **Teaching** - Share with study group or mentors
4. **Permanent Notes** - Document consolidated understanding
