...
**Purpose:** Rapid capture inbox for quick thoughts, ideas, voice memos, and temporary snippets. This is deliberately a messy space for immediate capture.
...
- Incomplete thoughts worth revisiting

## How It Works

1. **Capture** - Write quickly without worrying about formatting
2. **Review** - Monthly review of all fleeting notes
3. **Promote** - Develop promising ideas into [Permanent Notes](../03-permanent-notes/README.md)
4. **Archive** - Move old or irrelevant notes to [Archive](../06-archive/README.md)
...
- [Literature Notes](../02-literature-notes/README.md) - For curated source summaries
- [Permanent Notes](../03-permanent-notes/README.md) - Where good ideas become permanent knowledge
- [Tracking](../05-tracking/weekly-reviews/README.md) - For weekly review of progress
